...
function FaceVerificationSystem() {
  ...
  const [mode, setMode] = useState("appointment"); // Always start with appointment mode
  ...
  const loadModels = async () => {
    try {
      ...
      setStatus({
        message: "AI Models loaded! Starting appointment verification...",
        type: "success",
      });
    } catch (error) {
      setStatus({
  ...
  const startCamera = async () => {
    try {
      ...
      setStatus({
        message: "Camera active! Follow the instructions for verification.",
        type: "info",
      });
    ...
    cooldownIntervalRef.current = setInterval(() => {
      setCooldownSeconds((prev) => {
        if (prev <= 1) {
          ...
          // Reset the system after cooldown
          resetVerification();
          return 0;
        }
        return prev - 1;
  ...
  const captureAndVerify = async () => {
    ...
    if (isCapturingRef.current || isInCooldown) {
      console.log("Already capturing or in cooldown, skipping");
      return;
    }
    try {
      ...
      setIsVerifying(true);
      setStatus({
        message: "Processing appointment verification...",
        type: "info",
      });
      ...
      console.log("About to call verifyAppointmentArrival");
      ...
      stopCamera();
      // Start cooldown after verification
      startCooldown();
    } catch (error) {
  ...
  const resetVerification = () => {
    ...
    setStatus({
      message: "System ready for next verification",
      type: "info",
    });
    setIsVerifying(false);
    blinkCountRef.current = 0;
  ...
  if (verificationResult && !isInCooldown) {
    return (
              ...
              className={`p-6 text-white ${
                ...
                verificationResult.scenario === "medical_record_found"
                  ...
                  : verificationResult.scenario === "no_face_data" ||
                      verificationResult.scenario === "no_appointments"
            ...
            <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="bg-emerald-50 border-2 border-emerald-300 rounded-lg p-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      ...
                      <div className="bg-white rounded-lg p-4 border border-emerald-200">
                        <div className="text-xs text-gray-600 mb-1">Doctor</div>
                        <div className="text-lg font-bold text-gray-900">
                ...
                <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <p className="text-sm text-gray-700 mb-3">
                      Your face is not registered in our system. Please proceed
                      to the reception desk for manual check-in.
                    </p>
                ...
                <div className="bg-gray-50 border-2 border-gray-300 rounded-lg p-6">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <p className="text-sm text-gray-700 mb-3">
                      ...
                      Please contact reception if you believe this is an error.
                    </p>
                    <div className="text-xs text-gray-600">
                      <strong>Note:</strong> You can only check in for
              ...
              <div className="mt-6 flex flex-col sm:flex-row items-center justify-center gap-4">
                <button
                  ...
                  className={`inline-flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition shadow-sm ${
                    isInCooldown
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
              ...
              <div className="p-5">
                ...
                <div
                  className={`relative mb-5 ${
                    cameraActive && !isInCooldown ? "block" : "hidden"
                  }`}
                >
                ...
                {isInCooldown && (
                  <div className="text-center p-10 bg-amber-50 border border-amber-200 rounded-lg">
                    <div className="w-14 h-14 mx-auto mb-4 text-amber-600">
                    ...
                    <p className="text-amber-700 mb-4">
                      Please wait {cooldownSeconds} seconds before the next
                      verification
                    </p>
                    <div className="w-48 h-2 bg-amber-200 rounded-full overflow-hidden mx-auto">
                      <div
                        className="h-full bg-amber-500 transition-all"
                        style={{
                          width: `${((5 - cooldownSeconds) / 5) * 100}%`,
                        }}
                      ></div>
                    </div>
                  </div>
          ...
          <div className="space-y-4">
              ...
              <div className="flex items-start gap-2">
                ...
                <div>
                  ...
                  <ol className="space-y-1.5 text-xs text-blue-800">
                    ...
                    <li>5. System checks appointment automatically</li>
                  </ol>
                  {isInCooldown && (
                    <div className="mt-3 p-2 bg-amber-100 rounded text-xs text-amber-800">
                      ⏱️ System will automatically reset in {cooldownSeconds}{" "}
                      seconds
                    </div>
                  )}
                </div>
            ...
            >
              {isInCooldown
                ? `Manual Restart Available in ${cooldownSeconds}s`
                : "Manual Restart"}
            </button>
          </div>
        </div>
        ...
        <div className="mt-5 flex justify-center">
          <div className="inline-flex items-center gap-5 bg-white border border-gray-200 px-6 py-2.5 rounded-lg shadow-sm">
            ...
            <div className="flex items-center gap-2">
              <div
                className={`w-2 h-2 rounded-full ${
                  isInCooldown ? "bg-amber-500" : "bg-gray-400"
                }`}
              ></div>
              <span className="text-xs font-medium text-gray-700">
